...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
  ...
  static final int CIRCLE_DIAMETER = 56;
...
//  WindmillDrawable mProgress;
  LottieDrawable mDrawable;
...
//    mCircleView.getBackground().setAlpha(targetAlpha);
  ...
  public void setSize(int size) {
    ...
    mDrawable.setRepeatMode(LottieDrawable.REVERSE);
//    mDrawable.setImagesAssetsFolder("animation/");
    LottieComposition.Factory.fromRawFile(getContext(), R.raw.refresh, new OnCompositionLoadedListener() {
      @Override
      public void onCompositionLoaded(@Nullable LottieComposition lottieComposition) {
        mDrawable.setComposition(lottieComposition);
      }
    });
    mDrawable.setRepeatCount(100);
...
//      mProgress.setArrowScale(1 - interpolatedTime);
  ...
  public interface OnChildScrollUpCallback {
     ...
     */
    boolean canChildScrollUp(@NonNull SwipeRefreshLayout parent,
                             @Nullable View child);
  }
}
